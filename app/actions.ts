...
export async function getIPOAnalysis(ticker: string) {
  ...
  const prompt = `You are a financial analyst specializing in IPOs and public equity.
    ...
    1. Identify the company associated with this ticker symbol. 
    ...
    2. Craft an in-depth analysis of this company's IPO.
    ...
    Reflect on all publicly available data relevant to this company. Consider financials, growth prospects, competitive landscape, sector trends, management team, risk factors, and market sentiment. 
